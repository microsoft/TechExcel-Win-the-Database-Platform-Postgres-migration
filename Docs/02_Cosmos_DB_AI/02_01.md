...
## Success criteria
- You authenticated to Azure, trusted the HTTPS dev certificate, and ran the project without errors.
- The basic chat UI launched and showed a placeholder response in the conversation window (such as, “Placeholder response”).
- You successfully accessed the .NET Aspire dashboard locally (e.g., http://localhost:8100), which indicates the app is listening and reachable.
